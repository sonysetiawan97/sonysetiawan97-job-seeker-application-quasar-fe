  ...
  return {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => {
          try {
            const isExist = require(`pages/${collection}/register.vue`);
            if (isExist) {
              return import("pages/" + collection + "/register.vue");
            }
          } catch (error) {
            return import("pages/onWork.vue");
          }
        },
      },
    ],
