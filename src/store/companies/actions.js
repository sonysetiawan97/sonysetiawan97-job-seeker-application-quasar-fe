...
export async function detail(
  ...
  const promise = new Promise((resolve, reject) => {
    return api
      .get(ROUTE_DETAIL, { params, headers, ...config })
      .then((response) => {
        const { data /** , status, statusText, headers, config **/ } = response;
        resolve(data);
      })
...
export async function destroy(
  { state, commit, dispatch, getters },
  { type, data, params, headers = {}, config = {} }
) {
  var token = Cookies.get("authorization_token");
  if (token) {
    headers = { Authorization: `Bearer ${token}`, ...headers };
  ...
  const promise = new Promise((resolve, reject) => {
    return api
      .delete(ROUTE_DESTROY, { data, params, headers, ...config })
      .then((response) => {
        const { data /** , status, statusText, headers, config **/ } = response;
        resolve(data);
      })
...
export async function hardDelete(
  ...
  const promise = new Promise((resolve, reject) => {
    return api
      .delete(ROUTE_DELETE, { data, params, headers, ...config })
      .then((response) => {
        const { data /** , status, statusText, headers, config **/ } = response;
        resolve(data);
      })
...
export async function trash(
  ...
  const promise = new Promise((resolve, reject) => {
    return api
      .get(ROUTE_TRASH, { params, headers })
      .then((response) => {
        const { data /** , status, statusText, headers, config **/ } = response;
        resolve(data);
      })
...
export async function trashed(
  ...
  const promise = new Promise((resolve, reject) => {
    return api
      .get(ROUTE_TRASHED, { params, headers, ...config })
      .then((response) => {
        const { data /** , status, statusText, headers, config **/ } = response;
        resolve(data);
      })
...
export async function restore(
  ...
  const promise = new Promise((resolve, reject) => {
    return api
      .post(ROUTE_RESTORE, data, { params, headers, ...config })
      .then((response) => {
        const { data /** , status, statusText, headers, config **/ } = response;
        resolve(data);
      })
...
export async function register(
  ...
  config = { ...getters.config, ...config };
  const { collection } = state;
  const ROUTE_CREATE = `/${collection}/register`;
  const promise = new Promise((resolve, reject) => {
    return api
      .post(ROUTE_CREATE, data, { params, headers, ...config })
      .then((response) => {
